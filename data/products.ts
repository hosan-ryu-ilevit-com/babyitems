...
export const products: Product[] = [
  {
    ...
    coreValues: {
      ...
      material: 3,            // 미달 - 실리콘에서 하얀 가루, 안전성 우려
      usability: 3,           // 미달 - 뻑뻑한 다이얼
      portability: 10,        // 매우 충족 - 접이식, 프리볼트
      priceValue: 8,          // 충족 - 휴대용 관점에서 합리적
      durability: 5,          // 보통
      additionalFeatures: 8   // 충족 - 찜기 포함
    }
  },
  {
    id: '6962086794',
    ...
    coreValues: {
      ...
      material: 8,            // 충족 - 붕규산 유리, SUS316
      usability: 5,           // 보통 - 무게, 민감한 터치, 소음
      portability: 1,         // 매우 미달 - 유리, 무거움
      priceValue: 8,          // 충족 - 기능 대비 합리적
      durability: 6,          // 보통 - 유리 파손 위험
      additionalFeatures: 8   // 충족 - 차망, 요거트 기능
    }
  },
  {
    id: '8025187240',
    ...
    coreValues: {
      ...
      material: 10,           // 매우 충족 - SUS316, BPA-Free, 차일드락
      usability: 3,           // 미달 - 터치 인식률 낮음, 뚜껑 누수
      portability: 5,         // 보통 - 무선이지만 크고 무거움
      priceValue: 5,          // 보통 - 비싼 가격, 내구성 문제
      durability: 4,          // 미달 - 초기 불량 다수
      additionalFeatures: 5   // 보통 - 세척솔 제공
    }
  },
  {
    id: '8248083200',
    ...
    coreValues: {
      ...
      material: 5,            // 보통 - SUS304, 치명적 설계결함(물 오작동)
      usability: 3,           // 미달 - 1L 작은용량, 물 흘러내림
      portability: 1,         // 매우 미달 - 가정용
      priceValue: 3,          // 미달 - 성능 대비 비쌈
      durability: 2,          // 매우 미달 - 바닥 물 침투 고질병
      additionalFeatures: 8   // 충족 - 디자인 우수
    }
  },
  {
    id: '8832134810',
    ...
    coreValues: {
      ...
      usability: 5,           // 보통 - 뻑뻑한 버튼, 느린 가열
      portability: 10,        // 매우 충족 - 접이식, 프리볼트
      priceValue: 8,          // 충족
      durability: 6,          // 보통 - QC 문제
  ...
  },
  {
    ...
    coreValues: {
      ...
      usability: 5,           // 보통 - 짧은 전원선
      portability: 10,        // 매우 충족 - 접이식, 프리볼트
      priceValue: 8,          // 충족
      durability: 5,          // 보통 - 일부 단기 고장
      additionalFeatures: 8   // 충족 - 세척기능, LCD
    }
  },
  {
    id: '7118428974',
    ...
    coreValues: {
      ...
      usability: 5,           // 보통 - 민감한 터치, 냉각팬 소음
      portability: 1,         // 매우 미달
      priceValue: 10,         // 매우 충족 - 최고 가성비
      durability: 3,          // 미달 - 유리 파손 빈번
      additionalFeatures: 8   // 충족 - 다양한 모드
    }
  },
  {
    id: '6699913168',
    ...
    coreValues: {
      ...
      usability: 5,           // 보통 - 무거움, 뚜껑 헐거움
      portability: 1,         // 매우 미달
      priceValue: 10,         // 매우 충족 - 5만원대 가성비
      durability: 3,          // 미달 - 유리 파손
      additionalFeatures: 8   // 충족 - 모유데우기 모드
    }
  },
  {
    id: '8356115729',
    ...
    coreValues: {
      ...
      usability: 5,           // 보통 - 뚜껑 고정 안됨, 짧은 선
      portability: 10,        // 매우 충족 - 8.5cm 접이식, 프리볼트
      priceValue: 5,          // 보통 - 비싼 편
      durability: 4,          // 미달 - 초기 불량 多
      additionalFeatures: 8   // 충족 - 염소제거, 계란삶기
    }
  },
  {
    id: '8682829959',
    ...
    coreValues: {
      ...
      usability: 5,           // 보통 - 무거움
      portability: 8,         // 충족 - 무선, 텀블러형 (but 무거움)
      priceValue: 8,          // 충족
      durability: 7,          // 보통
      additionalFeatures: 10  // 매우 충족 - 자체살균, 세련된 디자인
    }
  },
  {
    id: '8599323586',
    ...
    coreValues: {
      ...
      material: 8,            // 충족 - 올스텐 SUS304
      usability: 8,           // 충족 - 1.7L 대용량, 가벼움
      portability: 1,         // 매우 미달
      priceValue: 10,         // 매우 충족 - 5만원 내 통스텐
      durability: 8,          // 충족
      additionalFeatures: 8   // 충족 - 미려한 디자인
    }
  },
  {
    id: '8950011599',
    ...
    coreValues: {
      ...
      usability: 3,           // 미달 - 무거움, 긴 충전시간
      portability: 5,         // 보통 - 무선이나 무거움
      priceValue: 5,          // 보통 - 내구성 문제
      durability: 3,          // 미달 - 잦은 고장
      additionalFeatures: 8   // 충족 - 자동세척, C타입
    }
  },
  {
    id: '8591558719',
    ...
    coreValues: {
      ...
      usability: 3,           // 미달 - 짧은 선, 뻑뻑한 뚜껑
      portability: 1,         // 매우 미달
      priceValue: 5,          // 보통
      durability: 2,          // 매우 미달 - 녹, 증기 새어나옴
      additionalFeatures: 10  // 매우 충족 - 압도적 디자인
    }
  },
  {
    id: '8723454926',
