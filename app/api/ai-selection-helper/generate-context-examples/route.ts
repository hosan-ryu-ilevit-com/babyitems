...
**응답 형식 (JSON):**
{
  "examples": ["지금 쓰는 포트 소음이 너무 커요", "아기가 배앓이가 있고 변비가 심해요", "기저귀가 밤에 자꾸 새서 불편해요", "4개월 된 7kg 아기 키우고 있어요", "쌍둥이라 수유 준비가 너무 힘들어요", "맞벌이라 준비할 시간이 부족해요", "통세척 되고 세척 쉬운 거 찾아요", "가성비가 제일 중요해요", "외출할 때 휴대하기 편한 거 필요해요"]
}`;
