...
- 좋은 예시 (상황 설명):
  ...
  - "SUV 타는데 공간 차지 적은 거 찾아요"

## 중요 규칙 (스타일 준수):
1. **물음표(?)로 끝나는 의문문을 쓰지 마세요.** 
   - ❌ 나쁜 예: "경차 타는데 공간 차지 적은거 있을까요?", "어떤 게 좋을까요?"
   - ⭕️ 좋은 예: "경차 타는데 공간 차지 적은 카시트를 찾아요", "가벼운 유모차가 필요해요"
2. 문장 끝맺음: "~찾아요", "~좋아요", "~원해요", "~추천해주세요", "~필요해요", "~모르겠어요" 
3. 각 예시는 12-30자 내외
4. 실제 사용자가 입력할 것 같은 자연스러운 말투
5. 단순 기능 나열이 아닌, 요청/상황 설명 느낌으로`;
