...
**예시 1:**
입력:
- 어떤 용도로 사용하시나요? → 일상용, 여행용
- 가격 vs 품질 → 품질이 좋은 제품
- 직장 생활하느라 시간이 부족해요
- 관리가 편했으면 좋겠어요

출력:
"직장 생활을 하느라 시간이 부족해서 관리가 편한 제품을 찾고 있어요. 일상과 여행 시 모두 사용하려고 하고, 품질이 좋은 제품을 선호해요."
...
출력:
"아파트에 거주하고 있고 외출이 잦아서 매일 사용할 예정이에요. 휴대성이 좋은 제품을 선호해요."
