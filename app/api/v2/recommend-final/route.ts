...
- **리뷰 직접 인용**: "리뷰가 많아요" (❌) → "'새벽 수유 때 빨리 먹여서 좋다'고 했어요" (✅)
...
- **⚠️ 절대 금지**: "X개 중 Y개", "X%", "X개", "대부분", "많은" 같은 개수/비율 표현
- **⚠️ 영어 절대 금지**: 영어 알파벳, 언더스코어(_) 사용 금지

※ recommendationReason은 1~2문장, 최대 3문장으로 작성하세요.
※ **작성 후 반드시 확인**: 응답에 영어가 있으면 안 됩니다!

### 좋은 예시 (리뷰 직접 인용 + 스펙-효과 연결)
- "선택하신 빠른 가열 조건에 맞춰, 300W 고출력으로 2분 내 데워져요. '새벽 수유 때 빨리 먹여서 좋다'는 평이 많아요"
- "세척 편의를 중요하게 보셨는데, 분리형 3단 구조로 구석구석 닦을 수 있어요. '세척 편하다'는 리뷰가 많아요"
- "소음을 걱정하셨죠. 저소음 모터(35dB)라 조용하고, '조용해서 아기 안 깨요'라는 평이에요"
- "가볍고 휴대 편한 걸 원하셨는데, 850g으로 한 손에 들고 다닐 수 있어요. '여행 갈 때 챙겨가요'라는 후기가 있어요"
- "신생아부터 써야 한다고 하셨죠. 0개월부터 36개월까지 쓸 수 있고, '신생아 때부터 잘 썼다'는 평이에요"
- "스테인리스 소재를 선호하셨는데, 304 스테인리스로 내구성이 좋아요. '오래 써도 변색 없어요'라는 리뷰가 있어요"
