...
사용자가 선택한 조건을 기반으로, 조건에 맞는 제품 1차 후보들을 추렸다는 것을 전달하는 공감어린 요약 메시지를 한 줄로 생성해주세요. 
...
4. 한 문장으로 작성해주세요
5. 이모지는 사용하지 마세요
6. 영어 변수명이나 시스템 용어(예: hard_filter, rule_ 등)는 절대 사용하지 말고 자연스러운 한국어로 풀어쓰세요

## 예시
- "**신생아**를 위한 **절충형** 유모차를 찾으시는군요! **42개** 제품이 조건에 맞아요."
- "**팬티형** 기저귀, **6개월 이상** 아기에게 딱 맞는 **28개** 제품이 조건에 맞아요."
