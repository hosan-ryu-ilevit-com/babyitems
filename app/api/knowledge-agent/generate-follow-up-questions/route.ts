...
- **⛔ '상관없어요' 류 옵션 생성 금지 (매우 중요!):**
  - UI에 이미 '상관없어요' 버튼과 '기타 - 직접 입력' 옵션이 자동으로 제공됨
  - 복수 선택도 가능하므로 여러 옵션을 동시에 선택 가능
  - **❌ 절대 금지 - 중복되는 애매한 옵션:**
    * "둘다 상관없어요" / "모두 좋아요" / "다 괜찮아요"
    * "신경쓰지 않아요" / "상관 안해요" / "어떤 것도 괜찮아요"
    * "딱히 선호 없음" / "특별한 선호 없음"
  - **✅ 올바른 예 - 구체적인 선택지만:**
    * "양쪽에 눈금" vs "한쪽에만 눈금"
    * "밤에도 조용" vs "낮에만 사용"
    * "넉넉한 수납 공간" vs "최소한의 공간"
  - **원칙:** 모든 옵션은 구체적인 선택지여야 하며, 사용자는 '상관없어요'를 별도로 선택 가능
