...
- **형식:** "**키워드**: 한 문장 설명" (25~40자)
- 단순 스펙 나열이 아닌 **사용자가 얻는 이익(Benefit)** 중심
- **Good:** "**저소음**: 35dB로 밤중에도 아기가 깨지 않음"
- **Good:** "**급속가열**: 1분 내 적정 온도 도달로 새벽 수유에 딱"
- **Bad:** ❌ "**압도적인 냄새 제거력**: 다수의 사용자 경험을 통해 이전 제품들의 심각했던 냄새 문제를 해결했다는 점이 가장 큰 강점입니다..." (너무 김)

### 3️⃣ 단점 (consFromReviews) - 2가지
- **형식:** "**키워드**: 한 문장 설명" (25~40자)
- 치명적 결함보다는 **구매 전 고려할 Trade-off** 위주
- **Good:** "**무게감**: 안정감은 있지만 이동 시 무거움"
- **Good:** "**가격대**: 입문용 대비 2배 이상"
- **Bad:** ❌ "**처리 시간**: 일부 사용자 리뷰에서 '7시간'이라는 처리 시간이 언급되었습니다..." (너무 김)
...

{
  "results": [
    {
      "pcode": "12345678",
      "prosFromReviews": ["**저소음**: 35dB로 밤중에도 아기가 깨지 않음", "**급속가열**: 1분 내 적정 온도 도달", "**통세척**: 분리 없이 물로 헹굼 가능"],
...
⚠️ JSON만 출력하세요!
⚠️ prosFromReviews/consFromReviews: "**키워드**: 한 문장" 형식, 25~40자 (길면 안됨!)
