...
요구사항:
- 정확히 1개의 문단으로만 작성 (2-3문장)
- "고객님" 또는 "분유포트를 찾으시는 분들께"와 같은 호칭 사용
- 분유포트를 처음 구매하는 고객님 관점에서 공감하는 톤
- 장점을 중심으로 설명하되, 객관적으로
- 이모지는 사용하지 마세요
- 인사말이나 중복된 소개는 하지 마세요

답변은 바로 제품 소개로 시작하세요. 예시: "${product.title}은/는 ..." 형식으로 시작`;
