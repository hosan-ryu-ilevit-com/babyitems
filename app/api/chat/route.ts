...
BudgetRange 옵션:
- "0-50000": 최대 5만원 (0~5만원)
- "0-100000": 최대 10만원 (0~10만원)
- "0-150000": 최대 15만원 (0~15만원)
- "150000+": 15만원+ (예산 제한 없음, 모든 가격대 포함)
...
JSON 형식으로 답변하세요:
{
  "budget": "0-50000" 또는 "0-100000" 또는 "0-150000" 또는 "150000+" 또는 null
}`;
