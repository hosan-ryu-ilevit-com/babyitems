...
**중요도 분류 기준:**
- "중요함": "매우 중요", "중요", "최우선", "꼭 필요", "절대적", "가장 중요", "신경써야", "고려해야", 여러 세부 항목을 강조
- "보통": "보통", "괜찮", "크게 상관없", "일반적", "그냥", 중간 정도의 관심
- "중요하지 않음": "안 중요", "별로", "신경 안 써도 됨", "중요하지 않음", "상관없음", 대부분의 세부 항목이 중요하지 않음
...
{
  "type": "importance_response | follow_up_question | off_topic",
  "importance": "중요함 | 보통 | 중요하지 않음" (type이 importance_response인 경우만),
