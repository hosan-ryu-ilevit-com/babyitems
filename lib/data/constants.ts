...
export const CATEGORY_BUDGET_OPTIONS: Record<Category, BudgetOption[]> = {
  baby_bottle: [
    ...
    { label: '최대 3만원', value: '10000-30000', desc: '인기 제품', popular: true },
    { label: '최대 5만원', value: '30000-50000', desc: '프리미엄' },
    { label: '5만원+', value: '50000+', desc: '최고급' },
  ],
  baby_bottle_sterilizer: [
    { label: '최대 15만원', value: '0-150000', desc: '기본 기능' },
    { label: '최대 25만원', value: '150000-250000', desc: '더 좋은 기능', popular: true },
    { label: '최대 35만원', value: '250000-350000', desc: '프리미엄' },
    { label: '35만원+', value: '350000+', desc: '최고급' },
  ],
  baby_formula_dispenser: [
    { label: '최대 30만원', value: '0-300000', desc: '기본 기능' },
    { label: '최대 45만원', value: '300000-450000', desc: '더 좋은 기능', popular: true },
    { label: '최대 60만원', value: '450000-600000', desc: '프리미엄' },
    { label: '60만원+', value: '600000+', desc: '최고급' },
  ],
  baby_monitor: [
    { label: '최대 3만원', value: '0-30000', desc: '기본 기능' },
    { label: '최대 5만원', value: '30000-50000', desc: '인기 제품', popular: true },
    { label: '최대 7만원', value: '50000-70000', desc: '프리미엄' },
    { label: '7만원+', value: '70000+', desc: '최고급' },
  ],
  baby_play_mat: [
    { label: '최대 5만원', value: '0-50000', desc: '기본형' },
    { label: '최대 15만원', value: '50000-150000', desc: '인기 제품', popular: true },
    { label: '최대 30만원', value: '150000-300000', desc: '프리미엄' },
    { label: '30만원+', value: '300000+', desc: '최고급' },
  ],
  car_seat: [
    { label: '최대 15만원', value: '0-150000', desc: '기본 기능' },
    { label: '최대 40만원', value: '150000-400000', desc: '인기 제품', popular: true },
    { label: '최대 70만원', value: '400000-700000', desc: '프리미엄' },
    { label: '70만원+', value: '700000+', desc: '최고급' },
  ],
  milk_powder_port: [
    { label: '최대 5만원', value: '0-50000', desc: '기본 기능' },
    { label: '최대 10만원', value: '50000-100000', desc: '더 좋은 소재+편의 기능', popular: true },
    { label: '최대 15만원', value: '100000-150000', desc: '프리미엄 기능' },
    { label: '15만원+', value: '150000+', desc: '최고급' },
  ],
  nasal_aspirator: [
    { label: '최대 3만원', value: '0-30000', desc: '기본 기능' },
    { label: '최대 5만원', value: '30000-50000', desc: '인기 제품', popular: true },
    { label: '최대 10만원', value: '50000-100000', desc: '프리미엄' },
    { label: '10만원+', value: '100000+', desc: '최고급' },
  ],
  thermometer: [
    { label: '최대 4만원', value: '0-40000', desc: '기본 기능' },
    { label: '최대 7만원', value: '40000-70000', desc: '인기 제품', popular: true },
    { label: '최대 10만원', value: '70000-100000', desc: '프리미엄' },
    { label: '10만원+', value: '100000+', desc: '최고급' },
  ],
};
