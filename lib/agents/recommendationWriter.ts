...
- **맥락 반영 (매우 중요!)**:
  - 페르소나의 **contextualNeeds** (추가 요청사항에서 추출한 구체적 니즈)를 **반드시 반영**
  - 예: contextualNeeds에 "쌍둥이 육아"가 있다면 → "쌍둥이를 동시에 케어하기에 적합"
  - 예: "빠른 온도 조절" 니즈 → "바쁜 새벽 수유 시에도 빠르게 준비"
...
✅ "**쌍둥이 육아** 상황에서 동시에 분유를 타기에 적합한 **넓은 용량**이에요." (contextualNeeds 반영)
❌ "온도 조절이 좋습니다." (구체성 부족)
...
- **페르소나의 contextualNeeds를 반드시 우선적으로 반영해주세요** (추가 요청사항에서 추출한 구체적 상황)
  - contextualNeeds 배열의 각 항목을 장점/단점 설명에 자연스럽게 녹여내기
  - 예: "쌍둥이 육아 중"이면 → "동시에 여러 개 준비하기 좋음"
  - 예: "외출 많음"이면 → "휴대성/간편함 강조"
...
- **비교 형식 준수**: 반드시 "[비교 대상의 순위]위 제품 대비: [현재 제품의 차별점]" 형식으로 작성
  - 예: 2위 제품을 설명한다면 → "1위 제품 대비: ...", "3위 제품 대비: ..."
