...
- **자연스러운 톤**:
  ...
  - **⚠️ 절대 금지**: 점수, 등급, 수치 언급 ("8점", "9/10", "85점", "A등급" 등)
  - ✅ 올바른 표현: "뛰어나다", "우수하다", "탁월하다", "매우 좋다" 등
...
### 작성 방법:
- **근거**: 각 제품의 detailedFeatures를 **면밀히 비교**하여 실제 차별점 찾기
  - ⚠️ 중요: OTHER_CANDIDATES의 detailedFeatures를 **반드시 읽고** 비교하세요
  - 단순히 현재 제품만 보지 말고, 다른 제품의 장점/단점과 대조하세요
- **구체성**: "더 좋다"가 아닌 **구체적인 기능/특징** 비교
  - ✅ 좋은 예: "2위 대비 **보온 시간이 2시간 더 길고** **온도 유지력**이 뛰어나요"
  - ❌ 나쁜 예: "2위보다 성능이 좋아요"
- **간결함**: 1문장으로 핵심 차별점만
- **객관성**: 다른 제품 폄하 금지
- **⚠️ 절대 금지**: 점수, 등급 비교 ("85점 vs 92점", "A등급 vs B등급" 등)
- **마크다운 강조**: 차별점 **볼드** 처리

### 예시 (1위 제품):
✅ [
  "2위 제품 대비: **보온 시간이 3시간 더 길고** **온도 유지력**이 뛰어나요",
  "3위 제품 대비: **입구가 넓어 세척이 편리**하고 **분해 청소**가 가능해요"
]

### 예시 (2위 제품):
✅ [
  "1위 제품 대비: **가격이 3만원 저렴**하면서도 **온도 조절 기능은 동일**해요",
  "3위 제품 대비: **디자인이 더 심플**하고 **공간 차지가 적어요**"
]

❌ "2위 제품보다 좋습니다." (형식 불일치, 구체성 부족)
❌ "2위는 85점, 1위는 92점입니다." (점수 직접 비교 금지!)
❌ "2위 대비 성능이 우수합니다." (구체적인 차별점 없음)
...
❌ "종합 만족도 9/10으로 높은 제품입니다." (점수 언급 금지!)
...
✅ **점수, 등급, 수치를 절대 언급하지 않았나요?** ("8점", "9/10", "85점", "A등급" 모두 금지!)
✅ 모든 텍스트를 존댓말로 작성했나요? ("~해요", "~세요")
✅ 비교 형식을 준수했나요? ("[순위]위 제품 대비: ...")
✅ **비교 섹션에서 OTHER_CANDIDATES의 detailedFeatures를 면밀히 비교했나요?**
✅ 비교 내용이 **구체적인 기능/특징**을 포함하나요? ("더 좋다" 같은 막연한 표현 금지)
