...
- **자연어 표현**: 점수(8점, 9점 등)를 직접 언급하지 말고 자연어로 풀어서 표현
  - ❌ "온도 조절 점수가 9점으로 우수합니다"
  - ✅ "온도 조절 기능이 **매우 뛰어나**"
- **마크다운 강조**: 중요한 키워드나 특징은 **볼드**로 감싸기

예시:
✅ "고객님께서 가장 중요하게 생각하시는 **온도 조절 기능**이 매우 뛰어나, **정확한 온도 유지**가 가능합니다."
❌ "온도 조절이 좋습니다." (구체성 부족)
...
- **자연어 표현**: 점수를 직접 언급하지 말고 자연스럽게 표현
- **마크다운 강조**: 필요시 **볼드** 사용

예시:
✅ "다만 **휴대성**이 다소 떨어져, 여행용보다는 **가정용**으로 적합합니다."
❌ "휴대하기 어렵습니다." (구체성 부족)
...
예시:
✅ "2위 제품 대비 **온도 유지력**이 우수하며, 3위 제품보다 **세척이 훨씬 편리**합니다. 고객님의 우선순위인 온도 조절과 위생 관리 측면에서 가장 **균형 잡힌** 선택입니다."
...
예시:
✅ "리뷰 **1,234건**으로 검증된 제품이며, 첫 사용 전 **식초 세척**을 권장합니다."
...
- **점수(8점, 9점 등)를 절대 직접 언급하지 말 것** - 자연어로 표현 (예: 뛰어나다, 우수하다, 좋다, 보통이다, 부족하다)
- 중요한 키워드와 특징은 **마크다운 볼드**로 감싸서 강조
