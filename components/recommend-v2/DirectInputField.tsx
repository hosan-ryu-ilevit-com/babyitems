  ...
  return (
    ...
    >
      {showRegisteredState ? (
        ...
        <div className="relative flex gap-2">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="px-3 py-2.5 rounded-xl text-[14px] font-medium text-gray-500 hover:bg-gray-100 transition-all"
            >
              취소
            </button>
            <motion.button
        ...
        <button
          onClick={handleEdit}
          className="w-full h-[46px] rounded-xl border-2 border-dashed border-gray-200 bg-white flex items-center justify-center gap-2 text-gray-600 hover:border-gray-300 hover:bg-gray-50 transition-all active:scale-[0.98]"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <line x1="12" y1="5" x2="12" y2="19"></line>
            <line x1="5" y1="12" x2="19" y2="12"></line>
          </svg>
          <span className="text-[14px] font-medium">직접 입력하기</span>
        </button>
      )}
