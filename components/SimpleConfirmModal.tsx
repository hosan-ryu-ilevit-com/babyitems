    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Modal Container */}
          <div className="fixed bottom-[40px] left-0 right-0 px-4 z-[210] pointer-events-none">
            <motion.div
            ...
            >
              <div className="bg-white rounded-[16px] shadow-xl overflow-hidden flex flex-col">
                {/* Title */}
